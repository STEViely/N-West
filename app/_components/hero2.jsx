...
export default function Hero2() {
  return (
    <div className="w-full  flex justify-center mt-4 relative border-[2px] border-[#0000fe]">
      {/* <div className="w-[50%] bg-black text-white lg:p-20 "> */}
      ...
      {/* <div className="w-[50%] relative">
        <Image src={i6} alt="Hero" className="w-[50%] h-auto" />
